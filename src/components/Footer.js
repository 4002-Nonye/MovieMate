    ...
    <footer className="bg-black  w-full h-full ">
      ...
      <div className="w-12/12 h-full flex justify-between px-4 lg:px-11 pt-7  m-auto">
        ...
        <div className="flex justify-between ">
          <a className="link" href="http://www.twitter.com/the_altekid"  target={'_blank'}>
            <motion.svg
              whileHover={{ fill: "#f87171" }}
              className='btmlink'
          ...
          <a href="http://www.github.com/4002-nonye"target={'_blank'}>
            <motion.svg
              whileHover={{ fill: "#f87171" }}
         className='btmlink'
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a href="http://www.linkedin.com/in/ojukwu-nonye-51020023a"  target={'_blank'}>
            <motion.svg
              whileHover={{ fill: "#f87171" }}
         className='btmlink'
              fill="#94a3b8"
